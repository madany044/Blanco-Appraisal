    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blanco-primary to-slate-800">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center text-white mb-12">
          ...
          <p className="text-lg text-blue-100">Employee Progress Report Card — Salary Appraisal System</p>
          <p className="text-sm text-blue-200 mt-2">Financial Year 2026–27</p>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          <Card className="hover:shadow-xl transition-shadow">
            <CardHeader>
              ...
              <CardDescription>Secure login for authorized staff</CardDescription>
            </CardHeader>
            <CardContent>
              <Link href="/login">
