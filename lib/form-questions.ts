...
export const SELF_RATING_ITEMS = [
  { key: "rateTeamwork", mgrKey: "mgrRateTeamwork", letter: "a", topic: "Teamwork and Collaboration" },
  { key: "rateCompanyRelationship", mgrKey: "mgrRateCompanyRelationship", letter: "b", topic: "Relationship with the company" },
  { key: "ratePmRelationship", mgrKey: "mgrRatePmRelationship", letter: "c", topic: "Working Relationship with your PM" },
  { key: "rateCoworkerComms", mgrKey: "mgrRateCoworkerComms", letter: "d", topic: "Communication with Co-worker" },
  { key: "rateEngineering", mgrKey: "mgrRateEngineering", letter: "e", topic: "Engineering knowledge" },
  { key: "rateTeamCommunication", mgrKey: "mgrRateTeamCommunication", letter: "f", topic: "Ability to effectively communicate with team members and superiors" },
  { key: "rateVerbalWritten", mgrKey: "mgrRateVerbalWritten", letter: "g", topic: "Clarity on your own verbal and written communication" },
  { key: "rateEnglish", mgrKey: "mgrRateEnglish", letter: "h", topic: "English communication during office premises" },
  { key: "rateSelfLearning", mgrKey: "mgrRateSelfLearning", letter: "i", topic: "Self-learning abilities" },
  { key: "rateQualityOfWork", mgrKey: "mgrRateQualityOfWork", letter: "j", topic: "quality of work and execution" },
  { key: "rateDeadlines", mgrKey: "mgrRateDeadlines", letter: "k", topic: "meeting deadlines and completing tasks on time" },
  { key: "rateClientComms", mgrKey: "mgrRateClientComms", letter: "l", topic: "Communicating with Client" },
  { key: "rateCustomerEmails", mgrKey: "mgrRateCustomerEmails", letter: "m", topic: "Understanding the customer e-mails (without help of anyone)" },
  { key: "rateRfiCreation", mgrKey: "mgrRateRfiCreation", letter: "n", topic: "Creating the RFI's (without help of anyone)" },
  { key: "rateEmailWriting", mgrKey: "mgrRateEmailWriting", letter: "o", topic: "Writing back the e-mail to customer (without help of anyone)" },
  { key: "rateIssueResolution", mgrKey: "mgrRateIssueResolution", letter: "p", topic: "resolving the issues without help of anyone" },
  { key: "rateKnowledgeSharing", mgrKey: "mgrRateKnowledgeSharing", letter: "q", topic: "sharing knowledge and conducting classes to Juniors" },
  { key: "rateLeadership", mgrKey: "mgrRateLeadership", letter: "r", topic: "Professional Leadership quality during office premises (selfless teaching, happiness with the team, motivating co-workers, achieving together, helping together)" },
  { key: "rateTeamPerformance", mgrKey: "mgrRateTeamPerformance", letter: "s", topic: "Your Team performance" },
  { key: "rateTeamBuilding", mgrKey: "mgrRateTeamBuilding", letter: "t", topic: "Team build abilities" },
] as const;
